...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIScrollToSelection : MonoBehaviour
    {
        ...
        [Header("[ Input ]")] [SerializeField] private bool cancelScrollOnInput = false;
        [SerializeField] private List<KeyCode> cancelScrollKeycodes = new();
        ...
        {
            if (CancelScrollOnInput == false || IsManualScrollingAvailable == true) return;
        ...
        private void ScrollRectToLevelSelection()
        {
            ...
            if (selection == null || selection.transform.parent != LayoutListGroup.transform) return;
