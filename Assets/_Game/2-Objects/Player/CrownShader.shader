...
Shader "CrownShader"
{
	Properties
	{
		...
		_AmbientOcclussion("AmbientOcclussion", 2D) = "white" {}
		_AlbedoMult("AlbedoMult", Color) = (1,1,1,0)
		_SmoothMultiplier("SmoothMultiplier", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_AmbientOcclussion = IN.ase_texcoord8.xy * _AmbientOcclussion_ST.xy + _AmbientOcclussion_ST.zw;
				float2 texCoord10 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				
				float4 tex2DNode12 = tex2D( _Metallic, texCoord10 );
				
				float3 Albedo = ( _AlbedoMult * ( tex2D( _AmbientOcclussion, uv_AmbientOcclussion ).r * tex2D( _Albedo, texCoord10 ) ) ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, texCoord10 ), 1.0f );
				float3 Emission = ( _EmissionColor * _EmissionStrength ).rgb;
				float3 Specular = 0.5;
				float Metallic = tex2DNode12.r;
				float Smoothness = ( tex2DNode12.a * _SmoothMultiplier );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_AmbientOcclussion = IN.ase_texcoord4.xy * _AmbientOcclussion_ST.xy + _AmbientOcclussion_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_AmbientOcclussion = IN.ase_texcoord2.xy * _AmbientOcclussion_ST.xy + _AmbientOcclussion_ST.zw;
...
/*ASEBEGIN
Version=18935
-1710;408;1707;948;513.1652;196.9946;1;True;True
Node;AmplifyShaderEditor.SamplerNode;11;-536.5264,-128.8479;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;22;50.83484,15.0054;Inherit;False;Property;_EmissionColor;EmissionColor;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;319.8348,57.0054;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;32.16404,-140.5372;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;472.8649,-50.83707;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;16;214.1648,-258.8371;Inherit;False;Property;_AlbedoMult;AlbedoMult;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;13.83484,200.0054;Inherit;False;Property;_EmissionStrength;EmissionStrength;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;156.6649,415.8628;Inherit;False;Property;_SmoothMultiplier;SmoothMultiplier;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-535.3579,68.5584;Inherit;True;Property;_Metallic;Metallic;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-938.6506,67.44875;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;491.0648,306.6628;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;20;-543.6208,289.2523;Inherit;True;Property;_Normal;Normal;5;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-550.236,-336.8372;Inherit;True;Property;_AmbientOcclussion;AmbientOcclussion;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0445557482BCAF4DAE7051DDE7C0E8B2E2030ABA