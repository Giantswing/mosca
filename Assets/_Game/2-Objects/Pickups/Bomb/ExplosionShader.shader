...
Shader "ExplosionShader"
{
	Properties
	{
		...
		_TimeMult("TimeMult", Range( 0 , 2)) = 1
		_OffsetMult("OffsetMult", Range( 0 , 1)) = 0.1
		_ClipThreshold("ClipThreshold", Range( 0 , 1)) = 0
		_TexTiling("TexTiling", Vector) = (1,1,0,0)
		_TexTilingNoise("TexTilingNoise", Vector) = (1,1,0,0)
		[ASEEnd]_uvDistort("uvDistort", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 texCoord30 = v.ase_texcoord.xy * _TexTilingNoise + float2( 0,0 );
				float2 texCoord11 = v.ase_texcoord.xy * _TexTiling + float2( 0,0 );
				float cos25 = cos( ( _TimeParameters.x * _TimeMult ) );
				float sin25 = sin( ( _TimeParameters.x * _TimeMult ) );
				float2 rotator25 = mul( texCoord11 - float2( 0.5,0.5 ) , float2x2( cos25 , -sin25 , sin25 , cos25 )) + float2( 0.5,0.5 );
				float4 tex2DNode10 = tex2Dlod( _NoiseTex, float4( ( tex2Dlod( _uvDistort, float4( texCoord30, 0, 0.0) ).r + rotator25 ), 0, 0.0) );
				...
				#endif
				float3 vertexValue = ( ( tex2DNode10.g * v.vertex.xyz ) * _OffsetMult );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord30 = IN.ase_texcoord3.xy * _TexTilingNoise + float2( 0,0 );
				float2 texCoord11 = IN.ase_texcoord3.xy * _TexTiling + float2( 0,0 );
				float cos25 = cos( ( _TimeParameters.x * _TimeMult ) );
				float sin25 = sin( ( _TimeParameters.x * _TimeMult ) );
				float2 rotator25 = mul( texCoord11 - float2( 0.5,0.5 ) , float2x2( cos25 , -sin25 , sin25 , cos25 )) + float2( 0.5,0.5 );
				float4 tex2DNode10 = tex2D( _NoiseTex, ( tex2D( _uvDistort, texCoord30 ).r + rotator25 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2DNode10 * _MainColor ).rgb;
				float Alpha = tex2DNode10.g;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord30 = IN.ase_texcoord2.xy * _TexTilingNoise + float2( 0,0 );
				float2 texCoord11 = IN.ase_texcoord2.xy * _TexTiling + float2( 0,0 );
				float cos25 = cos( ( _TimeParameters.x * _TimeMult ) );
				float sin25 = sin( ( _TimeParameters.x * _TimeMult ) );
				float2 rotator25 = mul( texCoord11 - float2( 0.5,0.5 ) , float2x2( cos25 , -sin25 , sin25 , cos25 )) + float2( 0.5,0.5 );
				float4 tex2DNode10 = tex2D( _NoiseTex, ( tex2D( _uvDistort, texCoord30 ).r + rotator25 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord30 = IN.ase_texcoord.xy * _TexTilingNoise + float2( 0,0 );
				float2 texCoord11 = IN.ase_texcoord.xy * _TexTiling + float2( 0,0 );
				float cos25 = cos( ( _TimeParameters.x * _TimeMult ) );
				float sin25 = sin( ( _TimeParameters.x * _TimeMult ) );
				float2 rotator25 = mul( texCoord11 - float2( 0.5,0.5 ) , float2x2( cos25 , -sin25 , sin25 , cos25 )) + float2( 0.5,0.5 );
				float4 tex2DNode10 = tex2D( _NoiseTex, ( tex2D( _uvDistort, texCoord30 ).r + rotator25 ) );
				
				surfaceDescription.Alpha = tex2DNode10.g;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord30 = IN.ase_texcoord1.xy * _TexTilingNoise + float2( 0,0 );
				float2 texCoord11 = IN.ase_texcoord1.xy * _TexTiling + float2( 0,0 );
				float cos25 = cos( ( _TimeParameters.x * _TimeMult ) );
				float sin25 = sin( ( _TimeParameters.x * _TimeMult ) );
				float2 rotator25 = mul( texCoord11 - float2( 0.5,0.5 ) , float2x2( cos25 , -sin25 , sin25 , cos25 )) + float2( 0.5,0.5 );
				float4 tex2DNode10 = tex2D( _NoiseTex, ( tex2D( _uvDistort, texCoord30 ).r + rotator25 ) );
...
/*ASEBEGIN
Version=18935
-1787;1365;1707;848;1025.713;286.4082;1.38553;True;True
Node;AmplifyShaderEditor.RangedFloatNode;17;-1318.131,434.1585;Inherit;False;Property;_TimeMult;TimeMult;3;0;Create;True;0;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-1223.236,355.0792;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;24;-1278.064,-40.31947;Inherit;False;Property;_TexTiling;TexTiling;6;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;29;-1298.913,-251.7126;Inherit;False;Property;_TexTilingNoise;TexTilingNoise;7;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1107.673,-48.91743;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-1014.465,352.97;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;30;-1072.913,-206.7126;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotatorNode;25;-687.577,250.1003;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;26;-738.7183,-283.9708;Inherit;True;Property;_uvDistort;uvDistort;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;28;-252.4455,-93.78729;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PosVertexDataNode;19;82.79482,538.234;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;43.70416,15.1377;Inherit;True;Property;_NoiseTex;NoiseTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;314.7616,491.8411;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;21;193.5065,689.0125;Inherit;False;Property;_OffsetMult;OffsetMult;4;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;15;-1243.27,135.765;Inherit;False;Property;_PanSpeed;PanSpeed;2;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;13;64.87292,219.8071;Inherit;False;Property;_MainColor;MainColor;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;502.4439,482.3515;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;487.6854,130.1836;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;23;388.57,341.0626;Inherit;False;Property;_ClipThreshold;ClipThreshold;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;486.7661,60.84576;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;1;3;10;2
WireConnection;1;4;23;0
WireConnection;1;5;22;0
ASEEND*/
//CHKSM=5B0E67C0A88540C7DE473E35D5FDAC9A2DE0EAF3