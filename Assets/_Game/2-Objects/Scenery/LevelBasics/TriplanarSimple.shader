...
Shader "TriplanarSimple"
{
	Properties
	{
		...
		[ASEEnd]_Tiling("Tiling", Vector) = (0.5,0.5,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar10 = TriplanarSampling10( _TopTexture0, WorldPosition, WorldNormal, 1.0, _Tiling, 1.0, 0 );
				
				float3 Albedo = ( triplanar10 * 0.4117647 ).xyz;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar10 = TriplanarSampling10( _TopTexture0, WorldPosition, ase_worldNormal, 1.0, _Tiling, 1.0, 0 );
...
/*ASEBEGIN
Version=18935
-1885;155;1807;1053;1229.5;560.5;1;True;True
Node;AmplifyShaderEditor.TriplanarNode;10;-513,-26.5;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;11;-708,62.5;Inherit;False;Property;_Tiling;Tiling;1;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-39,-11.5;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-376,183.5;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;0.4117647;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=08C178047B43A6F0616E69A43A859CF1256A4DC4