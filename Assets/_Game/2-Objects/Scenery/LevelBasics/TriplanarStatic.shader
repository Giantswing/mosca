...
Shader "TriplanarStatic"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling12( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar12 = TriplanarSampling12( _Texture0, _Texture0, _Texture0, IN.ase_texcoord8.xyz, IN.ase_normal, 1.0, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
				
				float3 Albedo = ( triplanar12 * 0.4117647 ).xyz;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar12 = TriplanarSampling12( _Texture0, _Texture0, _Texture0, IN.ase_texcoord5.xyz, IN.ase_normal, 1.0, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar12 = TriplanarSampling12( _Texture0, _Texture0, _Texture0, IN.ase_texcoord3.xyz, IN.ase_normal, 1.0, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
...
/*ASEBEGIN
Version=18935
157;1440;1920;1059;1817.025;677.5703;1.3;True;True
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-355.3903,-53.45068;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-692.3904,141.5493;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;0.4117647;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;13;-1031.39,122.5493;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;0.5,0.5;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TexturePropertyNode;14;-1071.546,-159.9144;Inherit;True;Property;_Texture0;Texture 0;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TriplanarNode;12;-829.3904,-68.45069;Inherit;True;Cylindrical;Object;False;Top Texture 0;_TopTexture0;white;2;None;Mid Texture 0;_MidTexture0;white;0;None;Bot Texture 0;_BotTexture0;white;1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5DC18BD1CF8A228F7D3AA07272AE2DF3D28B568A