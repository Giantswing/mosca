...
Shader "elevator_shader"
{
	Properties
	{
		...
		[ASEBegin]_albedoTexture("albedoTexture", 2D) = "white" {}
		_normalTexture("normalTexture", 2D) = "bump" {}
		_metallicTexture("metallicTexture", 2D) = "white" {}
		_SmoothMultiplier("SmoothMultiplier", Range( 0 , 2)) = 0.5
		_wallTriplanarAlbedo("wallTriplanarAlbedo", 2D) = "white" {}
		_TriplanarTiling("TriplanarTiling", Range( 0.1 , 3)) = 1
		[ASEEnd]_TriplanarBrightness("TriplanarBrightness", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			sampler2D _wallTriplanarAlbedo;
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult29 = (float2(_TriplanarTiling , _TriplanarTiling));
				float4 triplanar25 = TriplanarSampling25( _wallTriplanarAlbedo, IN.ase_texcoord8.xyz, IN.ase_normal, 1.0, appendResult29, 1.0, 0 );
				float2 texCoord19 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float vertexR14 = IN.ase_color.r;
				float4 lerpResult13 = lerp( ( triplanar25 * _TriplanarBrightness ) , tex2D( _albedoTexture, texCoord19 ) , vertexR14);
				
				float4 tex2DNode20 = tex2D( _metallicTexture, texCoord19 );
				float3 appendResult21 = (float3(tex2DNode20.r , tex2DNode20.g , tex2DNode20.b));
				
				float3 Albedo = lerpResult13.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _normalTexture, texCoord19 ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = appendResult21.x;
				float Smoothness = ( tex2DNode20.a * _SmoothMultiplier );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar25 = TriplanarSampling25( _wallTriplanarAlbedo, IN.ase_texcoord5.xyz, IN.ase_normal, 1.0, appendResult29, 1.0, 0 );
				float2 texCoord19 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float vertexR14 = IN.ase_color.r;
				float4 lerpResult13 = lerp( ( triplanar25 * _TriplanarBrightness ) , tex2D( _albedoTexture, texCoord19 ) , vertexR14);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar25 = TriplanarSampling25( _wallTriplanarAlbedo, IN.ase_texcoord3.xyz, IN.ase_normal, 1.0, appendResult29, 1.0, 0 );
...
/*ASEBEGIN
Version=18935
-1925;1336;1920;992;1591.793;674.759;1;True;True
Node;AmplifyShaderEditor.RegisterLocalVarNode;16;-1969.75,-249.9603;Inherit;False;vertexB;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-421.9919,580.4525;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;13;-381.803,-42.2087;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VirtualTextureObject;26;-1151.793,-547.759;Inherit;True;Property;_wallTriplanarAlbedo;wallTriplanarAlbedo;4;0;Create;True;0;0;0;False;0;False;-1;None;None;False;white;Auto;Unity5;0;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;31;-785.7935,-302.759;Inherit;False;Property;_TriplanarBrightness;TriplanarBrightness;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;25;-888.7935,-537.759;Inherit;True;Spherical;Object;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;17;-749.1352,47.93862;Inherit;False;14;vertexR;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-1206.335,-176.6614;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;29;-1255.793,-337.759;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;12;-891.4614,-181.9632;Inherit;True;Property;_albedoTexture;albedoTexture;0;0;Create;True;0;0;0;False;0;False;-1;3aeb01d3ce49d5544b36123c45fd7cde;3aeb01d3ce49d5544b36123c45fd7cde;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;20;-875.692,427.4525;Inherit;True;Property;_metallicTexture;metallicTexture;2;0;Create;True;0;0;0;False;0;False;-1;8580efbde86e8af4a8d3905716e70548;8580efbde86e8af4a8d3905716e70548;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;21;-457.9919,353.4525;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;22;-232.9919,488.4525;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;18;-860.3348,185.0386;Inherit;True;Property;_normalTexture;normalTexture;1;0;Create;True;0;0;0;False;0;False;-1;453344f96c31ff644b9ade45de554688;453344f96c31ff644b9ade45de554688;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-1575.793,-355.759;Inherit;False;Property;_TriplanarTiling;TriplanarTiling;5;0;Create;True;0;0;0;False;0;False;1;1;0.1;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-850.9919,632.4525;Inherit;False;Property;_SmoothMultiplier;SmoothMultiplier;3;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;15;-1960.75,-323.9603;Inherit;False;vertexG;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;11;-2147.472,-433.4856;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;14;-1968.52,-401.5825;Inherit;False;vertexR;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-520.7935,-314.759;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=AB2EC48A36C46F7E23BFA2DFE61F4C5E7D3C9FA8