...
Shader "rim-material"
{
	Properties
	{
		...
		[ASEBegin]_diffuseTexture("diffuseTexture", 2D) = "white" {}
		_TopTexture0("Top Texture 0", 2D) = "white" {}
		_smoothness("smoothness", 2D) = "gray" {}
		_tileamount22("tile-amount", Range( 0 , 1)) = 0.4941177
		_normal_map("normal_map", 2D) = "bump" {}
		_brightness("brightness", Range( 0 , 1)) = 0.3647059
		_SmoothMultiplier("SmoothMultiplier", Range( 0 , 10)) = 1
		_vertexOpacity("vertexOpacity", Range( 0 , 5)) = 1
		[ASEEnd]_AlphaCut("AlphaCut", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult22 = (float2(_tileamount22 , _tileamount22));
				float4 triplanar13 = TriplanarSampling13( _diffuseTexture, WorldPosition, WorldNormal, 1.0, appendResult22, 1.0, 0 );
				
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar39 = TriplanarSampling39( _normal_map, WorldPosition, WorldNormal, 1.0, appendResult22, 1.0, 0 );
				float3 tanTriplanarNormal39 = mul( ase_worldToTangent, triplanar39 );
				
				float4 triplanar50 = TriplanarSampling50( _smoothness, WorldPosition, WorldNormal, 1.0, appendResult22, 1.0, 0 );
				
				float4 triplanar60 = TriplanarSampling60( _TopTexture0, WorldPosition, WorldNormal, 1.0, appendResult22, 1.0, 0 );
				
				float lerpResult67 = lerp( 0.15 , _AlphaCut , triplanar50.r);
				
				float3 Albedo = saturate( ( ( triplanar13 * _brightness ) * pow( IN.ase_color.r , _vertexOpacity ) ) ).xyz;
				float3 Normal = tanTriplanarNormal39;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = saturate( ( IN.ase_color.r * ( triplanar50 * _SmoothMultiplier ) ) ).x;
				float Occlusion = 1;
				float Alpha = ( IN.ase_color.r * triplanar60.x );
				float AlphaClipThreshold = lerpResult67;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 triplanar60 = TriplanarSampling60( _TopTexture0, WorldPosition, ase_worldNormal, 1.0, appendResult22, 1.0, 0 );
				
				float4 triplanar50 = TriplanarSampling50( _smoothness, WorldPosition, ase_worldNormal, 1.0, appendResult22, 1.0, 0 );
				float lerpResult67 = lerp( 0.15 , _AlphaCut , triplanar50.x);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar13 = TriplanarSampling13( _diffuseTexture, WorldPosition, ase_worldNormal, 1.0, appendResult22, 1.0, 0 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 triplanar60 = TriplanarSampling60( _TopTexture0, ase_worldPos, ase_worldNormal, 1.0, appendResult22, 1.0, 0 );
				
				float4 triplanar50 = TriplanarSampling50( _smoothness, ase_worldPos, ase_worldNormal, 1.0, appendResult22, 1.0, 0 );
				float lerpResult67 = lerp( 0.15 , _AlphaCut , triplanar50.x);
				
				surfaceDescription.Alpha = ( IN.ase_color.r * triplanar60.x );
				surfaceDescription.AlphaClipThreshold = lerpResult67;
...
/*ASEBEGIN
Version=18935
-1932;1276;1920;1059;943.413;114.2416;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;30;-1598.986,-332.4543;Inherit;False;Property;_tileamount22;tile-amount;3;0;Create;False;0;0;0;True;0;False;0.4941177;0.4941177;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;22;-1261.526,-72.84174;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-93.86029,582.1254;Inherit;False;Property;_AlphaCut;AlphaCut;8;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;68;-326.0796,530.4897;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;0.15;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;10;-880.7279,-167.2568;Inherit;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;60;-950.2612,-488.6346;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;1;None;Mid Texture 3;_MidTexture3;white;-1;None;Bot Texture 3;_BotTexture3;white;-1;None;mask;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;50;-940.7856,145.9425;Inherit;True;Spherical;World;False;smoothness;_smoothness;gray;2;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;52;-472.2744,206.3301;Inherit;False;Property;_SmoothMultiplier;SmoothMultiplier;6;0;Create;True;0;0;0;False;0;False;1;4;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;67;262.6308,409.6828;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-186.3227,-664.4529;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SaturateNode;63;281.7383,59.50604;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;62.27987,-34.27124;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PowerNode;55;-147.4069,-202.4948;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;124.7067,148.8417;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;39;-931.5132,432.4404;Inherit;True;Spherical;World;True;normal_map;_normal_map;bump;4;None;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;54;-436.2744,-164.6699;Inherit;False;Property;_vertexOpacity;vertexOpacity;7;0;Create;True;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;13;-946.1225,-797.5558;Inherit;True;Spherical;World;False;diffuseTexture;_diffuseTexture;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-524.1228,-521.9529;Inherit;False;Property;_brightness;brightness;5;0;Create;True;0;0;0;False;0;False;0.3647059;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;64;403.746,-163.9238;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;2.951329,-284.9372;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-376.2744,-37.66986;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
WireConnection;1;0;64;0
WireConnection;1;1;39;0
WireConnection;1;4;63;0
WireConnection;1;6;61;0
WireConnection;1;7;67;0
ASEEND*/
//CHKSM=3F5D00A729B3DFDE8B74D0295934DA99DB5E5397