	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = saturate( ( IN.ase_color.b * ( triplanar50 * _SmoothMultiplier ) ) ).x;
				float Occlusion = 1;
				float Alpha = ( IN.ase_color.b * triplanar60.x );
				float AlphaClipThreshold = _AlphaCut;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( IN.ase_color.b * triplanar60.x );
				surfaceDescription.AlphaClipThreshold = _AlphaCut;
...
/*ASEBEGIN
Version=18935
-1920;196;1920;1052;640.254;377.9238;1;True;True
...
Node;AmplifyShaderEditor.TriplanarNode;60;-950.2612,-488.6346;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;1;Assets/_Game/00_SANDBOX/tex/rim-texture_diffuseOriginal.png;Mid Texture 3;_MidTexture3;white;-1;None;Bot Texture 3;_BotTexture3;white;-1;None;mask;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;10;-416.6508,-386.1021;Inherit;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;63;281.7383,59.50604;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TriplanarNode;50;-940.7856,145.9425;Inherit;True;Spherical;World;False;smoothness;_smoothness;gray;2;Assets/_Game/00_SANDBOX/tex/rim-texture_smoothness.png;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;56;251.0501,416.5175;Inherit;False;Property;_AlphaCut;AlphaCut;8;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TriplanarNode;13;-946.1225,-797.5558;Inherit;True;Spherical;World;False;diffuseTexture;_diffuseTexture;white;0;Assets/_Game/00_SANDBOX/tex/rim-texture_diffuseOriginal.png;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;39;-931.5132,432.4404;Inherit;True;Spherical;World;True;normal_map;_normal_map;bump;4;Assets/_Game/00_SANDBOX/tex/rim-texture_normal.png;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;129.6874,250.9451;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
