	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				#endif
				float3 vertexValue = ( ( tex2Dlod( _TextureSample1, float4( ( texCoord11 + mulTime20 ), 0, 0.0) ) * _wobbleStrenght_Instance ) * float4( v.vertex.xyz , 0.0 ) ).rgb;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18935
2553;167;1920;1041;1324.795;-14.021;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;26;-1352.863,561.0497;Inherit;False;InstancedProperty;_wobbleSpeed;wobbleSpeed;5;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;20;-1017.027,572.3794;Inherit;True;1;0;FLOAT;0.1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=6BA1B202E4D6B52E2466508B76BDF00556E3D2EA